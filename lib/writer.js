...
function writeFile(targetFile, name, licenses, version, callback) {
  if (fs.existsSync(targetFile)) {
    console.log('Found an existing licenses.txt file, replacing it.');
...
function writeAll(targetFile, modules, version, callback) {
  if (fs.existsSync(targetFile)) {
    console.log('Found an existing licenses.txt file, replacing it.');
    fs.unlinkSync(targetFile);
  }
